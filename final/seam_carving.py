...
class SeamCarver:
    def __init__(self, filename, out_height, out_width, protect_mask='', object_mask='', demo=False, fast_mode=False, energy='l1'):
        # 参数初始化
    ...
    def object_removal(self):
        ...
        #self.mask = - self.mask
        #print(np.sum(self.mask>0), np.sum(self.mask<0))
        if not rotate:
    ...
    def delete_seam(self, seam_idx):
        ...
        self.number_of_carving += 1
        print('{} seams carved !'.format(self.number_of_carving))
